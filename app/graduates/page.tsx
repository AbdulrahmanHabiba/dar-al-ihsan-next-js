          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="shadow-elegant">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  &ldquo;الحمد لله، تجربتي في دار الإحسان كانت رحلة إيمانية رائعة. المعلمون متمكنون وصبورون، والبيئة
                  التعليمية محفزة جداً. أنصح كل من يريد حفظ القرآن بالانضمام لهذه الدار المباركة.&rdquo;
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-elegant">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  &ldquo;بفضل الله ثم بفضل المعلمات في دار الإحسان، تمكنت من حفظ القرآن الكريم كاملاً. المنهج المتبع
                  احترافي وفعال، والمتابعة مستمرة. جزاهم الله خير الجزاء.&rdquo;
                </p>
              </CardContent>
            </Card>
          </div>
