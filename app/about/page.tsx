          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="relative h-[400px] w-full">
              <Image
                ...
                alt="القرآن الكريم"
                fill
                className="rounded-lg shadow-elegant object-cover"
              ...
              <CardContent className="p-8 md:p-12">
                <div className="grid md:grid-cols-[200px_1fr] gap-8 items-center">
                  ...
                  <div className="text-center md:text-right">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      فضيلة الشيخ أحمد مرعي، حافظ لكتاب الله، حاصل على إجازات في القرءان الكريم والمتون العلمية وكتب الحديث والفقه، له خبرة واسعة في تعليم القرآن الكريم وعلوم التجويد تمتد لأكثر من 20 عامًا. يشرف فضيلته على جميع البرامج التعليمية في الدار ويحرص على تطوير المناهج بما يخدم طلاب العلم.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
